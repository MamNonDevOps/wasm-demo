...
extern const unsigned char CsharpSpin_dll_62B539F5[];
extern const int CsharpSpin_dll_62B539F5_len;
...
void dotnet_wasi_registerbundledassemblies() {
  mono_wasm_add_assembly ("CsharpSpin.dll", CsharpSpin_dll_62B539F5, CsharpSpin_dll_62B539F5_len);
